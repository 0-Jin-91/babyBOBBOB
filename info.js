...
/*========== 백업 · 아기정보 · 초기화 ==========*/
function expJ(){dl(new Blob([JSON.stringify({v:7,baby:baby,logs:logs,tried:tried,my:myR,cubes:cubes,ov:ov,ph:ph,plan:plan,obs:obs,fav:fav,grow:grow,stock:(typeof STK!=='undefined'?STK:[]),bowl:(typeof BW!=='undefined'?BW:null),calc:LS('b6.calc',null)})],{type:'application/json'}),baby.name+'_이유식노트_백업.json')}
