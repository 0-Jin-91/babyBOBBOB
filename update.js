/*========== 🍼 새로고침 · 업데이트 확인 ==========*/
var APPV='22';                     /* index.html 의 ?v= 와 같은 값 */
...
+'<div class="alert ok" style="margin-top:10px"><span class="ic">✅</span><div><b>현재 버전 v'+APPV+'</b><br>더 새로운 버전이 없어요. 그대로 사용하세요.</div></div>'
+'<div class="cd" style="background:#F3F6FA;font-size:11.5px"><b>ℹ️ 새로고침이 필요할 때</b><div class="mu" style="font-size:11px;margin-top:5px;line-height:1.6">· 기능이 개선됐다는 안내를 받았을 때<br>· 화면이 이상하게 보이거나 버튼이 안 눌릴 때<br>· 오래 앱을 열어두었을 때<br><br>새로고침해도 <b>기록·재고·성장 데이터는 그대로</b> 유지됩니다.</div></div>'
