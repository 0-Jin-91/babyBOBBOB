...
/*----- 재료 -----*/
['재료 도감','재료 사전 시기 개월 언제부터 알레르기 영양','🥕','goFood(\'dict\')'],
['알레르기 3일 관찰','알레르기 관찰 새 재료 반응 발진 3일 타이머 시작 기록','🔔','goFood(\'obs\')'],
['알레르기 시기별 현황','시기별 신호등 초기 중기 후기 안한것 빠진것 밀린것 빨간불','🚦','goFood(\'chk\')'],
